# courtesy of Google Research: https://github.com/google-research/google-research/blob/master/representation_similarity/Demo.ipynb
import numpy as np
...
def fast_cka(X, Y, debiased=False):
